...
export function Showplace() {
  return (
    <>
      <Header />
      <div className={styles.details__imagesWrapper}>
        {" "}
        {/* className={styles.details__images-wrapper} */}
        <div className={styles.details__images}>
          {/*className={`${styles.details__slider-btn}  */}
          <p
            className={`${styles.details__sliderBtn} ${styles.details__previus}`}
            id="back"
          >
            {" "}
            &larr;{" "}
          ...
          <p
            className={`${styles.details__sliderBtn} ${styles.details__next}`}
            id="next"
          >
            {" "}
            &rarr;{" "}
